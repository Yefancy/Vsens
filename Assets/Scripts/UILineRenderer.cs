...
public class UILineRenderer : MaskableGraphic
{
    ...
    protected override void OnPopulateMesh(VertexHelper vh)
    {
        ...
        for (int i = 0; i < points.Length - 1; i++)
        {
            ...
            CreateLineSegment(points[i], points[i + 1], color1, color2, vh);
    ...
    private void CreateLineSegment(Vector3 point1, Vector3 point2, Color color1, Color color2, VertexHelper vh)
    {
